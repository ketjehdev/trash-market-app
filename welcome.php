...
<body>
    <div class="container">
        ...
        <div class="main">
            <div class="cards">
                ...
                <div class="card">
                    <div class="card-content">
                        ...
                        <div class="card-name">Konfirmasi pesanan</div>
                    </div>
                    <div class="icon-box">
                        <i class="fas fa-chalkboard-teacher"></i>
                    </div>
            ...
            <div class="charts">
                <div class="chart">
                    <h2>Layanan member</h2>
                    <canvas id="lineChart"></canvas>
                    <div class="cards">
                        <div class="card">
                            <div class="card-content">
                                <div class="card-name"><a href="PickUp.html">Pick up</a></div>
                            </div>
                            <div class="icon-box">
                        ...
                        <div class="card">
                            <div class="card-content">
                                <div class="card-name"><a href="Dropoff.html">Drop off</a></div>
                            </div>
                            <div class="icon-box">
