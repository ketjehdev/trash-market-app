...
<head>
	...
	<title>Register Member | Market Sampah</title>
	<!-- end of title -->
</head>
<!-- end of head -->
...
<body oncontextmenu="return false;">
	<div class="banner d-flex" style="width: 100%; height: 100vh;">
		<div class="col-4 forum d-flex flex-column align-items-center">
			...
			<p class="text-secondary text-center">- Register Member -</p>
			...
			<form action="" method="POST" style="width: 100%;" class="mx-2 mt-5">
				...
				<p class="text-center">Sudah mempunyai akun member? <br> <a href="login.php">Login member</a></p>
			</form>
		</div>

		<div class="col-8 box-img bg-success" style="height: 120vh;">
			<img src="asset/svg/register1.svg" class="bg">
		</div>
	</div>
